          ...
          if (event.keyCode === html.KeyCode.SPACE) {
            ...
            switch (currentFractal) {
              ...
              case 2:
              {
                ...
                for (let x = 0; x < width; x++) {
                  for (let y = 0; y < height; y++) {
                    if (main.isSierpinskiCarpetPixelFilled(x, y, 15) === 1) {
